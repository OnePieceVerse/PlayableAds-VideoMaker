        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-800 mb-4">
              Why Choose Playable Ads Maker?
            </h2>
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Professional tools designed for modern app marketers
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
            <FeatureCard 
              ...
              description="No coding required. Upload your video and customize with our intuitive interface." 
              icon={
            ...
            <FeatureCard 
              ...
              description="Export for Google Ads, Facebook, AppLovin, Unity, and more platforms." 
              icon={
                <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <FeatureCard 
              ...
              description="Add pause frames, CTA buttons, banners, and custom interactions." 
              icon={
                <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <FeatureCard 
              ...
              description="Start with proven templates or create from scratch." 
              icon={
                <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <FeatureCard 
              ...
              description="Built-in tracking and analytics to measure your ad performance." 
              icon={
                <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="py-20 bg-gradient-to-r from-blue-600 to-purple-600">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-4xl font-bold text-white mb-4">
            Ready to Create Your First Playable Ad?
          </h2>
          <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
            Join thousands of app marketers who are already using Playable Ads Maker to boost their conversion rates.
          </p>
          <Link 
            href="/create" 
