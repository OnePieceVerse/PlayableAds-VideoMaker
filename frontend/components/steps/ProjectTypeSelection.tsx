...
const ProjectTypeSelection: React.FC<ProjectTypeSelectionProps> = ({
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-8 max-w-5xl mx-auto">
      ...
      <div 
        className="bg-white border border-gray-200 rounded-xl shadow-md hover:shadow-lg transition-shadow duration-300 overflow-hidden cursor-pointer flex flex-col h-96"
        onClick={() => onSelectProjectType("video")}
      >
        <div className="h-48 bg-blue-100 flex items-center justify-center flex-shrink-0">
        ...
        <div className="p-6 flex flex-col flex-grow">
          ...
          <p className="text-gray-600 flex-grow">{t('interactiveVideoDesc')}</p>
      ...
      >
        <div className="h-48 bg-green-100 flex items-center justify-center flex-shrink-0">
        ...
        <div className="p-6 flex flex-col flex-grow">
          ...
          <p className="text-gray-600 flex-grow">{t('interactiveImageDesc')}</p>
          <div className="flex justify-end mt-4">
